...
pub const VAULT_CANNOT_INITIATE_TRANSFER: felt252 = 'VAULT_CANNOT_INITIATE_TRANSFER';
pub const VAULT_CANNOT_INITIATE_WITHDRAW: felt252 = 'VAULT_CANNOT_INITIATE_WITHDRAW';
