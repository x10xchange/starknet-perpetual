...
pub const CANT_LIQUIDATE_WITH_FP: felt252 = 'CANT_LIQUIDATE_WITH_FP';
pub const DIFFERENT_BASE_ASSET_IDS: felt252 = 'DIFFERENT_BASE_ASSET_IDS';
pub const INSUFFICIENT_APPROVAL: felt252 = 'INSUFFICIENT_APPROVAL';
...
pub const INVALID_SHRINK_TO_NEGATIVE: felt252 = 'INVALID_SHRINK_TO_NEGATIVE';
...
pub const INVALID_EXPIRATION: felt252 = 'INVALID_EXPIRATION';
...
pub const TRANSFER_NOT_TO_SAME_OWNER: felt252 = 'TRANSFER_NOT_TO_SAME_OWNER';
pub const INVEST_NOT_TO_SAME_OWNER: felt252 = 'INVEST_NOT_TO_SAME_OWNER';
pub const REDEEM_NOT_TO_SAME_OWNER: felt252 = 'REDEEM_NOT_TO_SAME_OWNER';
pub const LIQUIDATION_NOT_TO_SAME_OWNER: felt252 = 'LIQUIDATION_NOT_TO_SAME_OWNER';
...
pub fn spot_deleverage_non_spot_asset(asset_id: AssetId) -> ByteArray {
    format!("SPOT_DELEV_NON_SPOT_ASSET asset_id: {:?}", asset_id)
}
