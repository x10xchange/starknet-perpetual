...
pub const ASSET_REGISTERED_AS_SYNTHETIC: felt252 = 'ASSET_REGISTERED_AS_SYNTHETIC';
pub const COLLATERAL_ALREADY_REGISTERED: felt252 = 'COLLATERAL_ALREADY_REGISTERED';
...
pub const DEACTIVATED_ASSET: felt252 = 'DEACTIVATED_ASSET';
...
pub const INVALID_ZERO_RESOLUTION: felt252 = 'INVALID_ZERO_RESOLUTION';
