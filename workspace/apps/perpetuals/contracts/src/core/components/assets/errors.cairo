...
pub const ORACLE_PUBLIC_KEY_NOT_REGISTERED: felt252 = 'ORACLE_PK_NOT_REGISTERED';
...
pub const INVALID_TIME_DISTANCE_TO_BLOCK: felt252 = 'INVALID_TIME_DISTANCE_TO_BLOCK';
pub const INVALID_TIME_DECREASING: felt252 = 'INVALID_TIME_DECREASING';
