...
pub const INVALID_NON_SYNTHETIC_RF_TIERS: felt252 = 'INVALID_NON_SYNTHETIC_RF_TIERS';
pub const INVALID_SPOT_RF_BOUNDARY: felt252 = 'INVALID_SPOT_RF_BOUNDARY';
pub const INVALID_SPOT_RF_TIER_SIZE: felt252 = 'INVALID_SPOT_RF_TIER_SIZE';
