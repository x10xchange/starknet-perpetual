...
pub const SET_EVM_ACCOUNT_EXPIRED: felt252 = 'SET_EVM_ACCOUNT_EXPIRED';
...
pub const POSITION_HAS_EVM_ACCOUNT: felt252 = 'POSITION_HAS_EVM_ACCOUNT';
...
pub const INVALID_ZERO_EVM_ACCOUNT: felt252 = 'INVALID_ZERO_EVM_ACCOUNT';
pub const OWNER_ACCOUNT_REQUIRED: felt252 = 'OWNER_ACCOUNT_REQUIRED';
pub const WITHDRAWAL_RECIPIENT_NOT_OWNER: felt252 = 'WITHDRAWAL_RECIPIENT_NOT_OWNER';
