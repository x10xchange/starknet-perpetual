...
use super::types::order::OrderTrait;
...
pub fn validate_trade(
    ...
    assert(!have_same_sign(order_a.quote_amount, order_b.quote_amount), INVALID_QUOTE_AMOUNT_SIGN);
    assert(have_same_sign(order_a.base_amount, actual_amount_base_a), INVALID_ACTUAL_BASE_SIGN);
    assert(have_same_sign(order_a.quote_amount, actual_amount_quote_a), INVALID_ACTUAL_QUOTE_SIGN);
...
pub fn validate_order(order: Order, collateral_id: AssetId) {
