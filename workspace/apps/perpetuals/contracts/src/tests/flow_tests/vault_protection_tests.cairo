...
#[test]
#[should_panic(
    expected: "Vault Protection Limit Exceeded, position_id: PositionId { value: 101 }, tv_at_last_check: 60000, tv_after_operation: 56999, max_allowed_loss : 3000",
)]
...
#[test]
#[should_panic(
    expected: "Vault Protection Limit Exceeded, position_id: PositionId { value: 101 }, tv_at_last_check: 70000, tv_after_operation: 66499, max_allowed_loss : 3500",
)]
...
fn test_force_reset_protection_limit_allows_redemption() {
    ...
    state.facade.update_vault_protection_limit(vault_config.position_id, 10);
