...
pub fn assert_trade_event_with_expected(
    ...
    let expected_event = events::Trade {
        ...
        order_a_base_amount,
        order_a_quote_asset_id: COLLATERAL_ASSET_ID(),
        order_a_quote_amount,
        fee_a_asset_id: COLLATERAL_ASSET_ID(),
        fee_a_amount,
        order_b_position_id,
        order_b_base_asset_id: order_base_asset_id,
        order_b_base_amount,
        order_b_quote_asset_id: COLLATERAL_ASSET_ID(),
        order_b_quote_amount,
        fee_b_asset_id: COLLATERAL_ASSET_ID(),
        fee_b_amount,
